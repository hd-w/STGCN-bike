...
if __name__ == '__main__':
    ...
    net = STGCN(A_wave.shape[0],
                ...
                A_wave).to(device=args.device)

    net.double()

    # optimizer = torch.optim.Adam(net.parameters(), lr=1e-3)
    optimizer = torch.optim.Adam(net.parameters(), lr=5e-4, weight_decay=0.001)
    # optimizer = torch.optim.SGD(net.parameters(), lr=1e-3, momentum=0.9, weight_decay=0.001)
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max = 30, eta_min=0.00005, last_epoch=-1)
